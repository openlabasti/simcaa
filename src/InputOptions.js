...
class InputOptions extends Component {
    constructor(props) {
        ...
        this.state = {
             ...
             inputSize: [{type: 'size', value: 'mini', text: 'mini'},
                            {type: 'size', value: 'small', text: 'small'},
                            {type: 'size', value: 'large', text: 'large'},
                            {type: 'size', value: 'big', text: 'big'},
                            {type: 'size', value: 'huge', text: 'huge'},
                            {type: 'size', value: 'massive', text: 'massive'}],
